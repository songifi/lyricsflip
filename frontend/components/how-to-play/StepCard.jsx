  ...
  return (
    <motion.div
      className={`relative space-y-4 my-10 p-8 bg-black bg-opacity-30 backdrop-blur-sm rounded-2xl shadow-[0_0_15px_rgba(123,31,162,0.5)] border border-primary-light border-opacity-20 transition transform duration-300 ease-in-out ${
        hoveredStep === index
          ? "scale-105 shadow-[0_0_25px_rgba(123,31,162,0.8)]"
          : ""
      }`}
    ...
    >
      {/* Step number badge */}
      <div className="absolute -top-5 -left-5 w-10 h-10 rounded-full bg-primary-light flex items-center justify-center text-text-primary font-bold text-xl">
        {index + 1}
      </div>
