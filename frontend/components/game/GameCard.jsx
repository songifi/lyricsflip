...
const GameCard = () => {
  const { getCurrentQuestion, advanceQuestion } = useGameStore();
  ...
  // Listen for clicks outside the game card to open the confirmation modal
  useEffect(() => {
  ...
  return (
    <>
      <GameCardModal
        ...
        onConfirm={() => {
          // Add any quit logic here (e.g., reset game state) before closing
