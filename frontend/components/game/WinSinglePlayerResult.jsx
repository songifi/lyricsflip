...
const WinMultiplayerResult = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#090909]/25 backdrop-blur-[1px] flex justify-center items-center z-50">
      <div className="bg-white rounded-lg w-full max-w-[1008px] shadow-lg relative">
        {/* Header */}
        ...
        <div className="text-center flex flex-col items-center my-8 p-8">
          ...
          <h2 className="text-2xl mt-4 font-bold text-[#090909]">
            <span className="text-[#70E3C7]">368 Points</span> - You are
            amazingggg 🔥
          </h2>
        ...
        <div className=" top-0 left-0 right-0 w-full">
          <Image src="/img/confetti.png" alt="badge icon" fill className="object-cover" />
        </div>
      </div>
    </div>
  );
