...
const UserProfilePage = () => {
  return (
    <div className="relative overflow-hidden flex flex-col gap-6  w-full rounded-2xl  border border-[#DBE2E8] bg-[#F7F8F9] ">
      ...
      <div className=" lg:mx-10 mx-4 gap-4 sm:gap-6 sm:-mt-[6.5rem] -mt-[4.2rem] flex flex-col pb-10">
        <UserProfileHeader />
        <GameStatsOverview />
        <div className="grid grid-col-1 lg:grid-cols-2 gap-6 max-w-3xl lg:max-w-full mx-auto w-full">
          <Badges />
          <Statistics />
        </div>
      </div>
