...
const Navbar = () => {
  ...
  {mobileMenuOpen && (
    ...
    >
      ...
      <Dialog.Panel
        className="fixed inset-y-0 right-0 z-50 w-full max-w-xs overflow-y-auto bg-[#040311] px-6 py-6"
        role="dialog"
        aria-modal="true"
      >
        <div className="flex items-center justify-between">
          <span className="text-2xl font-bold text-white" id="mobile-menu-title">
            <img
              src="/assets/LyricsFlipLogo.svg"
              alt="LyricsFlip Logo"
              width="30"
