          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl lg:max-w-3xl xl:max-w-4xl relative z-[1]">
              <h1 className="lg:mt-16 text-[40px] md:text-5xl lg:text-6xl xl:text-7xl font-semibold tracking-tight text-pretty text-[#490878]">
                Sing <FaMusic className="inline text-[0.7em]" aria-hidden="true" /> Guess <FaMusic className="inline text-[0.7em]" aria-hidden="true" /> Earn
              </h1>
              ...
              <div className="mt-6 sm:mt-8 flex flex-col md:flex-row gap-4">
                <button
                  ...
                  aria-label="Start game and guess the song"
                >
                  Play Now
                </button>
            ...
            <div
              className="absolute top-48 left-[50%] -translate-x-[50%] lg:relative lg:top-0 lg:left-0 lg:translate-x-0 mt-14 sm:mt-24 lg:mt-20 lg:shrink-0 lg:grow"
              aria-hidden="true"
            >
              <FaMusic
                className="text-[220px] md:text-[250px] lg:text-[300px] xl:text-[350px] text-[#70E3C7] animate-customBounce"
                aria-hidden="true"
              />
            </div>
          </div>
