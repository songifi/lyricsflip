...
export default function HeroSection() {
  ...
  <section
    className="relative z-10 min-h-[800px] flex items-start pt-[200px]"
    ...
    <div className="container mx-auto px-4 w-full">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-start">
        <div className="w-full max-w-2xl lg:max-w-3xl xl:max-w-4xl relative z-[1] ml-2 lg:ml-4">
          <h1
            id="section-title"
            className="text-[56px] font-[800] tracking-tight text-white leading-tight font-geist"
          >
            Sing, Guess and Earn
          </h1>
          <p className="mt-6 text-base sm:text-lg md:text-xl text-white max-w-xl font-inter font-[300]">
            ...
            Discover your favorite genres, wager tokens, and compete for the top
            spot. Let the music challenge begin!
          </p>
