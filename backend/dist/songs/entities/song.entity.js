...
__decorate([
    (0, typeorm_1.ManyToOne)(() => difficulty_entity_1.Difficulty),
    (0, typeorm_1.JoinColumn)({ name: 'difficultyId' }),
    __metadata("design:type", difficulty_entity_1.Difficulty)
], Song.prototype, "difficulty", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Song.prototype, "difficultyId", void 0);
__decorate([
